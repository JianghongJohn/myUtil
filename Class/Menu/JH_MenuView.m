...
/**
 ...
 @return self
 */
- (instancetype)initWithFrame:(CGRect)frame withTitles:(NSArray *)titles withTintColor:(UIColor *)color
{
    self = [super initWithFrame:frame];
    if (self) {
        [self _craetHeaderView:titles withTintColor:color];
    }
    return self;
}
/**
 *  创建三个分类的头视图
 */
-(void)_craetHeaderView:(NSArray *)titles withTintColor:(UIColor *)color{
