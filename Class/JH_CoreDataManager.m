...
#import "JH_CoreDataManager.h"
#import <CoreData/CoreData.h>
@implementation JH_CoreDataManager
...
+ (JH_CoreDataManager *)sharedInstance {
    ...
    static JH_CoreDataManager * _sharedInstance = nil;
    
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        
        _sharedInstance = [[JH_CoreDataManager alloc] init];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"JH_CoreData.sqlite"];
